...
if __name__ == '__main__':
    ...
    df = df.rename(columns={0:'x_im',1:'im',2:'x_re',3:'re',4:'x_cond',5:'cond',6:'x_laser',7:'laser_profile',8:'x_gaussian_laser',9:'gassuian_fit_laser'})
    df.to_csv(savePath+'/linecuts.csv',index=False)
