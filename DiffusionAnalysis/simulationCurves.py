...
from config import naiveScale,diffusionCOMSOLScale,saveFigPath,diffusionCOMSOLCSV,trCOMSOLCSV,trCOMSOLScale,folderPathList,\
...
plotSimulatedImReCurves(diffusionCOMSOLCSV, saveFigPath,comsolScale=diffusionCOMSOLScale)#for iMIM diffusion

# plotSimulatedImReCurves(trCOMSOLCSV, saveFigPath,comsolScale=trCOMSOLScale) #for TR-iMIM
# plotSimulatedImReCurves_Linear(trCOMSOLCSV, saveFigPath,comsolScale=trCOMSOLScale) #for TR-iMIM
